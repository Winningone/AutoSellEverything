Below is the revised README using the same structure and style as your original file, with the outdated commands removed and the description updated for the current addon behavior.
